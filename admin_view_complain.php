        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    <div class="section-heading">
                        <h2>VIEW <em>COMPLAIN DETAIL</em></h2>
            ...
            <div class="row" id="tabs">
			  ...
			  <div class="col-lg-12">
				...
				$qur=mysql_query("select * from complain_detail where status not in('4','5')");
				if(mysql_num_rows($qur)>0)
				{
					...
					while($q=mysql_fetch_array($qur))
					{
						...
						echo "<td><a href='admin_update_complain_status.php?compid=$q[0]&cstatus=$q[4]'>UPDATE STATUS</a></td>";
						echo "</tr>";
					}
					echo "</table>";
